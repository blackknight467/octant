<!-- Previously rendered in Storybook as: Docs/Hacking/4. Release Process -->
...
Follow the console output and remove old changelog entries. Then create the new changelog file in the format `CHANGELOG-X.Y.md`.
...
8. The package will go through a series of automated checks and manual maintainer review before becoming the default version.
